  ...
  const filteredPayments = useMemo(() => {
    return payments.filter((payment) => {
      const matchesName =
        ...
        (payment.className || payment.course || "")
          .toLowerCase()
          .includes(nameFilter.toLowerCase());

      const matchesMonth =
        !monthFilter || payment.month?.toString() === monthFilter;
      const matchesYear =
        !yearFilter || payment.year?.toString() === yearFilter;
    ...
    <section>
      ...
      >
        ...
        >
          ...
          >
            <FaInfoCircle />
            Hiển thị {filteredPayments.length} trong tổng số {payments.length}{" "}
            bản ghi
            {(nameFilter || monthFilter || yearFilter) && (
              <span style={{ fontSize: "0.8rem", opacity: 0.8 }}>(đã lọc)</span>
            )}
          </p>
        </div>
      </div>
      ...
      {filteredPayments.length === 0 && payments.length > 0 && (
        ...
        >
          ...
          <p style={{ margin: 0, color: "#c53030", fontSize: "0.9rem" }}>
            Không có bản ghi nào phù hợp với bộ lọc hiện tại. Vui lòng thử lại
            với tiêu chí khác.
          </p>
        </div>
      )}
          ...
          >
            <div className="card-content">
              ...
              >
                ...
                >
                  <FaDollarSign
                    style={{ color: "#b30000", minWidth: "16px" }}
                  />
                  <span style={{ fontWeight: "600", minWidth: "80px" }}>
                    Số tiền:
                  </span>
              ...
              <button
                ...
                title={
                  payment.status === "Đã thanh toán"
                    ...
                    : payment.status === "Chờ xác thực"
                    ? "Đã có yêu cầu thanh toán đang chờ xác thực"
                    : payment.status === "Chờ xác nhận"
                    ? "Đang chờ xác nhận"
                    : "Thanh toán học phí"
                }
            ...
            (pageNumber) => (
              <button
                ...
                style={{
                  ...
                  border: "1px solid #b30000",
                  backgroundColor:
                    currentPage === pageNumber ? "#b30000" : "white",
