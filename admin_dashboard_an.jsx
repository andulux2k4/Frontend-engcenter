...
function AdminDashboard({ user, onLogout, onGoHome }) {
  ...
  const [tuitionList, setTuitionList] = useState([
    ...
    {
      id: 14,
      student: "Nancy Parker",
      parent: "Mrs. Parker",
      class: "Grammar Advanced",
      sessions: 19,
      amount: 4800000,
      paid: 0,
      date: "2024-03-02",
  ...
  const [notifications, setNotifications] = useState([
    {
      ...
      content:
        "Lớp IELTS Advanced sẽ bắt đầu từ 01/04/2024. Vui lòng kiểm tra lịch học chi tiết.",
      target: "Học sinh",
      type: "event",
      method: "Web",
      date: "20/03/2024",
    },
    {
      ...
      content:
        "Học viên vui lòng hoàn thành học phí tháng 3 trước ngày 25/03/2024.",
      target: "Học sinh",
    ...
    },
    {
      ...
      content:
        "Lớp TOEIC Preparation sẽ khai giảng vào 15/04/2024. Đăng ký ngay!",
      target: "Tất cả",
      type: "event",
      method: "Both",
      date: "17/03/2024",
    },
    {
      ...
      content:
        "Trung tâm sẽ nghỉ lễ từ 30/04 đến 02/05/2024. Các lớp học sẽ tạm dừng trong thời gian này.",
      target: "Tất cả",
      type: "holiday",
      method: "Both",
      date: "16/03/2024",
    },
    {
      ...
      content:
        "Kết quả thi thử IELTS tháng 3 đã có. Vui lòng liên hệ văn phòng để nhận kết quả.",
      target: "Học sinh",
      type: "result",
      method: "Email",
      date: "15/03/2024",
    },
    {
      ...
      content:
        "Lớp TOEIC Basic sẽ thay đổi lịch học từ thứ 2,4,6 sang thứ 3,5,7 từ tuần tới.",
      target: "Học sinh",
      type: "schedule",
      method: "Web",
      date: "14/03/2024",
    ...
    },
    {
      ...
      content:
        "Hệ thống quản lý sẽ bảo trì từ 22h00 đến 06h00 ngày mai. Vui lòng thông cảm.",
      target: "Tất cả",
      type: "maintenance",
      method: "Web",
      date: "12/03/2024",
    },
    {
      ...
      content:
        "Lớp Speaking Club mới sẽ khai giảng vào 20/04/2024. Đăng ký ngay để cải thiện kỹ năng nói!",
      target: "Học sinh",
      type: "event",
      method: "Email",
      date: "11/03/2024",
    },
    {
      ...
      content:
        "Học viên vui lòng hoàn thành học phí tháng 4 trước ngày 25/04/2024.",
      target: "Học sinh",
      type: "payment reminder",
      method: "Email",
      date: "10/03/2024",
    },
    {
      ...
      content:
        "Workshop Writing Skills sẽ diễn ra vào chủ nhật 28/04/2024. Đăng ký tham gia miễn phí!",
      target: "Học sinh",
      type: "workshop",
      method: "Both",
      date: "09/03/2024",
    },
    {
      ...
      content:
        "Cô Sarah sẽ nghỉ học ngày mai (15/03). Lớp IELTS Advanced sẽ được dạy bù vào thứ 7.",
      target: "Học sinh",
      type: "schedule",
      method: "Web",
      date: "08/03/2024",
  ...
  const [newTuitionData, setNewTuitionData] = useState({
    student: "",
    parent: "",
    class: "",
    sessions: "",
  ...
  const [advertisements, setAdvertisements] = useState([
    {
      ...
      content:
        "Lớp IELTS Advanced mới sẽ khai giảng vào tháng 4/2024. Đăng ký ngay để nhận ưu đãi 20% học phí!",
      startDate: "2024-03-01",
      endDate: "2024-04-30",
      status: "Hoạt động",
      images: [
        "https://via.placeholder.com/300x200/ff0000/ffffff?text=IELTS+Advanced",
      ],
    },
    {
      id: 2,
      ...
      content:
        "Giảm 15% học phí cho tất cả các khóa học trong tháng 3/2024. Áp dụng cho học viên mới.",
      startDate: "2024-03-01",
      endDate: "2024-03-31",
      status: "Hoạt động",
      images: [
        "https://via.placeholder.com/300x200/ff0000/ffffff?text=Discount+March",
      ],
    },
    {
      id: 3,
      ...
      content:
        "Lớp TOEIC cơ bản dành cho người mới bắt đầu. Cam kết đạt 500+ điểm sau 3 tháng.",
      startDate: "2024-02-15",
      endDate: "2024-03-15",
      status: "Đã ngừng",
      images: [
        "https://via.placeholder.com/300x200/ff0000/ffffff?text=TOEIC+Basic",
      ],
    },
    {
      id: 4,
      ...
      content:
        "Workshop Speaking Skills miễn phí dành cho tất cả học viên. Tham gia để cải thiện kỹ năng nói!",
      startDate: "2024-03-15",
      endDate: "2024-04-15",
      status: "Hoạt động",
      images: [
        "https://via.placeholder.com/300x200/ff0000/ffffff?text=Speaking+Workshop",
      ],
    },
    {
      id: 5,
      ...
      content:
        "Khóa học Business English dành cho người đi làm. Học tiếng Anh thương mại hiệu quả.",
      startDate: "2024-03-10",
      endDate: "2024-05-10",
      status: "Hoạt động",
      images: [
        "https://via.placeholder.com/300x200/ff0000/ffffff?text=Business+English",
      ],
    },
    {
      id: 6,
      ...
      content:
        "Lớp Grammar Advanced giúp học viên nắm vững ngữ pháp tiếng Anh nâng cao.",
      startDate: "2024-02-20",
      endDate: "2024-04-20",
      status: "Hoạt động",
      images: [
        "https://via.placeholder.com/300x200/ff0000/ffffff?text=Grammar+Advanced",
      ],
    },
    {
      id: 7,
      ...
      content:
        "Khóa học Writing Skills giúp học viên viết tiếng Anh chuyên nghiệp và hiệu quả.",
      startDate: "2024-03-05",
      endDate: "2024-05-05",
      status: "Hoạt động",
      images: [
        "https://via.placeholder.com/300x200/ff0000/ffffff?text=Writing+Skills",
      ],
    },
    {
      id: 8,
      ...
      content:
        "Lớp Reading Comprehension giúp học viên đọc hiểu tiếng Anh nhanh và chính xác.",
      startDate: "2024-03-12",
      endDate: "2024-05-12",
      status: "Hoạt động",
      images: [
        "https://via.placeholder.com/300x200/ff0000/ffffff?text=Reading+Skills",
      ],
    },
    {
      id: 9,
      ...
      content:
        "Khóa học Listening Practice giúp học viên luyện nghe tiếng Anh hiệu quả.",
      startDate: "2024-03-08",
      endDate: "2024-05-08",
      status: "Hoạt động",
      images: [
        "https://via.placeholder.com/300x200/ff0000/ffffff?text=Listening+Practice",
      ],
    },
    {
      id: 10,
      ...
      content:
        "Lớp Conversation Club giúp học viên thực hành giao tiếp tiếng Anh tự nhiên.",
      startDate: "2024-03-20",
      endDate: "2024-05-20",
      status: "Hoạt động",
      images: [
        "https://via.placeholder.com/300x200/ff0000/ffffff?text=Conversation+Club",
      ],
    },
    {
      id: 11,
      ...
      content:
        "Khóa học Academic Writing dành cho học viên muốn viết luận văn tiếng Anh.",
      startDate: "2024-03-25",
      endDate: "2024-05-25",
      status: "Hoạt động",
      images: [
        "https://via.placeholder.com/300x200/ff0000/ffffff?text=Academic+Writing",
      ],
    },
    {
      id: 12,
      ...
      content:
        "Lớp TOEIC Advanced giúp học viên đạt điểm cao trong kỳ thi TOEIC.",
      startDate: "2024-02-10",
      endDate: "2024-04-10",
      status: "Đã ngừng",
      images: [
        "https://via.placeholder.com/300x200/ff0000/ffffff?text=TOEIC+Advanced",
      ],
    },
  ]);
  ...
  const filteredTuitionList = tuitionList.filter(
    (t) =>
      (tuitionStatusFilter === "all" || t.status === tuitionStatusFilter) &&
      (t.student.toLowerCase().includes(tuitionSearch.toLowerCase()) ||
        t.class.toLowerCase().includes(tuitionSearch.toLowerCase()))
  );
  const totalPaid = tuitionList.reduce((sum, t) => sum + (t.paid || 0), 0);
  const totalUnpaid = tuitionList.reduce(
    (sum, t) => sum + (t.amount - (t.paid || 0)),
    0
  );
  ...
  const updatePagination = (setPaginationFunc, totalItems, currentPage = 1) => {
    ...
    setPaginationFunc((prev) => {
      ...
      if (
        ...
        prev.totalPages === Math.max(1, totalPages)
      ) {
        return prev;
      }
      return {
  ...
  const paginatedTuitions = getPaginatedData(
    filteredTuitionList,
    tuitionPagination
  );
  ...
  const paginatedAdvertisements = getPaginatedData(
    advertisements,
  ...
  function handleApproveTuition(id) {
    setTuitionList((list) =>
      list.map((t) =>
        t.id === id ? { ...t, status: "Đã duyệt", paid: t.amount } : t
      )
    );
  }
  function handleRejectTuition(id) {
    if (window.confirm("Bạn có chắc muốn từ chối khoản học phí này?"))
      setTuitionList((list) =>
        list.map((t) => (t.id === id ? { ...t, status: "Từ chối" } : t))
      );
  }
  ...
  function handleProofImageChange(e, setter) {
    ...
    if (file) {
      ...
      reader.onload = (ev) =>
        setter((prev) => ({ ...prev, proofImage: ev.target.result }));
  ...
  function handleAdvertisementSubmit(e) {
    ...
    if (editingAdvertisement) {
      setAdvertisements((list) =>
        list.map((ad) => (ad.id === editingAdvertisement.id ? newAd : ad))
      );
    ...
    setAdvertisements((list) =>
      list.map((ad) =>
        ad.id === id
          ? {
              ...ad,
              status: ad.status === "Hoạt động" ? "Đã ngừng" : "Hoạt động",
            }
          : ad
      )
    );
          ...
          <div className="hamburger-menu">
            ...
            >
              <div className="hamburger-icon">
                <MdOutlineApps
                  className="dashboard-burger-icon"
                  style={{ color: "white" }}
                />
              </div>
            </button>
        ...
        <main className="main-content">
          ...
          {activeTab === "classes" && (
            <section>
              ...
              {!loading &&
                classes.length > 0 &&
                classesPagination.totalPages > 1 && (
                  <Pagination
          ...
          {activeTab === "tuition" && (
            <section>
                    ...
                    {filteredTuitionList.length === 0 ? (
                      ...
                      paginatedTuitions.map((tuition) => (
                        ...
                        >
                          ...
                          <td style={{ color: "#b30000", fontWeight: 600 }}>
              ...
              {!loading &&
                filteredTuitionList.length > 0 &&
                tuitionPagination.totalPages > 1 && (
                  <Pagination
                ...
                <div className="modal">
                  <div className="modal-content" style={{ maxWidth: 420 }}>
                    ...
                    >
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td style={{ padding: "0.7rem", textAlign: "right" }}>
                            {detailTuitionData.amount?.toLocaleString()} VNĐ
                          </td>
                        </tr>
                        <tr>
                          <td
                          ...
                          <td style={{ padding: "0.7rem", textAlign: "right" }}>
                            {(detailTuitionData.paid || 0).toLocaleString()} VNĐ
                          </td>
                        </tr>
                        <tr>
                          <td
                          ...
                          <td style={{ padding: "0.7rem", textAlign: "right" }}>
                            {detailTuitionData.proofImage ? (
                              <img
                                src={detailTuitionData.proofImage}
                                alt="minh chứng"
                                style={{
                                  maxWidth: 120,
                                  maxHeight: 80,
                    ...
                    >
                      <button
                        className="btn btn-secondary"
                        onClick={() => setShowDetailTuitionModal(false)}
                      >
                        Đóng
                      </button>
                    </div>
                        ...
                        setTuitionList((list) => [
                          {
                            ...newTuitionData,
                            id: Date.now(),
                            amount: Number(newTuitionData.amount),
                            paid: Number(newTuitionData.paid) || 0,
                          },
                          ...list,
                        ]);
                    ...
                    >
                      ...
                      >
                        ...
                        <input
                          ...
                          accept="image/*"
                          onChange={(e) =>
                            handleProofImageChange(e, setNewTuitionData)
                          }
                          style={{ flex: 1, minWidth: 0 }}
                        />
                        {newTuitionData.proofImage && (
                          <img
                            src={newTuitionData.proofImage}
                            alt="minh chứng"
                            style={{
                              maxWidth: 60,
                              maxHeight: 40,
                      ...
                      >
                        <button
                          type="button"
                          className="btn btn-secondary"
                          onClick={() => setShowAddTuitionModal(false)}
                        >
                          Hủy
                        </button>
                        <button
                  ...
                  <tbody>
                    {paginatedSalaries.map((teacher) => {
                      ...
                      return (
                        ...
                        >
                          <td style={{ fontWeight: 600, color: "#b30000" }}>
                            {teacher.name}
                          </td>
                          <td style={{ textAlign: "center" }}>
                            {teacher.sessions}
                            ...
                            {status === "Trả hết" ? (
                              ...
                              <button
                                ...
                                onClick={(e) => {
                                  ...
                                  setSalaryModalData({
                                    teacher,
                                    amount: total - teacher.paidAmount,
                                  });
                                }}
                              >
                                Thanh toán
              ...
              {showDetailModal && detailData && (
                <div className="modal">
                  <div className="modal-content" style={{ maxWidth: 420 }}>
                    ...
                    >
                      <BiMoney style={{ fontSize: "1.5rem" }} /> Chi tiết lương
                      giáo viên
                    </h3>
                    <table
                      style={{
                      ...
                      onSubmit={(e) => {
                        ...
                        setSalaryList((list) =>
                          list.map((t) => ({
                            ...t,
                            period: salaryMonth
                              ? salaryMonth.split("-").reverse().join("/")
                              : t.period,
                          }))
                        );
                  ...
                  <div className="modal-content" style={{ maxWidth: 400 }}>
                    ...
                    <form
                      onSubmit={(e) => {
                        ...
                        setSalaryList((list) =>
                          list.map((t) =>
                            t.id === salaryModalData.teacher.id
                              ? {
                                  ...t,
                                  paidAmount:
                                    t.paidAmount +
                                    Number(salaryModalData.amount),
                                }
                              : t
                          )
                        );
                        alert(
                          `Đã thanh toán ${Number(
                            salaryModalData.amount
                          ).toLocaleString()} VNĐ cho ${
                            salaryModalData.teacher?.name
                          }`
                        );
              ...
              >
                {notifications.length === 0 ? (
                  ...
                  paginatedNotifications.map((noti) => (
                    <div
                      key={noti.id}
                      className="card notifications-card"
                      style={{
                        border: "1.5px solid #b30000",
                        background: "#fff5f5",
                        borderRadius: "1.1rem",
                        position: "relative",
                        boxShadow: "0 2px 12px rgba(179,0,0,0.07)",
                        ...
                        >
                          ...
                          >
                            ...
                            <button
                              ...
                              onClick={() =>
                                handleToggleAdvertisementStatus(ad.id)
                              }
                            >
                              {ad.status === "Hoạt động"
                                ? "Ngừng"
              ...
              {showDetailAdvertisement && detailAdvertisement && (
                <div className="modal">
                  <div className="modal-content" style={{ maxWidth: 700 }}>
                    ...
                    >
                      <MdCampaign style={{ fontSize: "1.5rem" }} /> Chi tiết
                      quảng cáo
                    </h3>
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            >
                              <span
                                className={`status-badge ${
                                  detailAdvertisement.status === "Hoạt động"
                                    ? "success"
                                    : "warning"
                                }`}
                                style={{
                          ...
                          <tr>
                            ...
                            <td
                              style={{ padding: "0.8rem", textAlign: "left" }}
                            >
                              {detailAdvertisement.images &&
                              detailAdvertisement.images.length > 0 ? (
                                <div
                                  style={{
                                    display: "grid",
                                    gridTemplateColumns:
                                ...
                                >
                                  {detailAdvertisement.images.map(
                                    (image, index) => (
                                      <div
                                        key={index}
                                        style={{
